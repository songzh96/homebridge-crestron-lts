...
export class FaucetAccessory {
  private service: Service;
  private id: number;
  private deviceType = 'Faucet';
  ...
  constructor(
    ...
    this.eventEmitter.on(`${this.deviceType}:${this.id}:${this.eventPowerStateMsg}`, this.eventFaucetStateMsgEvent.bind(this));
  ...
  async eventFaucetStateMsgEvent(value: number) {
